...
public class OpenApiConfig {
    ...
    public GroupedOpenApi groupedOpenApi() {
        return GroupedOpenApi.builder()
                .group("api-service-messaging")
                .packagesToScan(
                        "TTCS.MessagingService.Presentation.Command",
                        "TTCS.MessagingService.Presentation.Query")
                .build();
    }
    @Bean
    public OpenAPI customOpenAPI() {
        return new OpenAPI()
                .info(new Info().title("Messaging Service API").version("1.0"))
