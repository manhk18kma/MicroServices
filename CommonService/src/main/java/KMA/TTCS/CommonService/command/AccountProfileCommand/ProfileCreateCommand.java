...
public class ProfileCreateCommand {
    ...
    public ProfileCreateCommand(String idProfile, String fullName, String urlProfilePicture, String biography, Gender gender, Date dateOfBirth, String idAccount) {
